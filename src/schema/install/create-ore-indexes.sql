-- ORE/Open Rating Environment - $Id: create-ore-indexes.sql,v 1.3 2004/12/21 16:12:02 skandalfo Exp $
...
CREATE INDEX parameter_value_assigning_place_idx ON parameter_value(assigning_level, assigning_entity, parameter_id, initial_date);
CREATE INDEX parameter_value_parameter_id_idx ON parameter_value(parameter_id);
CREATE INDEX parameter_value_initial_date_idx ON parameter_value(initial_date);
CREATE INDEX parameter_value_parent_parameter_value_id_idx ON parameter_value(parent_parameter_value_id);
